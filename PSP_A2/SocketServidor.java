...
public class SocketServidor {
	...
	public static void main(String[] args) {
		...
		Libro l1 = new Libro("1234-4321-1", "La sombra del viento", "Carlos Ruiz Zafon", 10.95);
		Libro l2 = new Libro("9999-8888-2", "The Lord of the Rings", "J.R.R. Tolkien", 19.90);
		Libro l3 = new Libro("4321-1234-3", "El Codigo da Vinci", "Dan Brown", 16.95);
		Libro l4 = new Libro("9999-8888-4", "El diario de Ana Frank", "Anna Frank", 12.00);
		Libro l5 = new Libro("5555-4444-5", "Fundacion", "Isaac Asimov", 14.20);
		//añadir libros
		libros.add(l1);
		libros.add(l2);
		libros.add(l3);
